...
--   isGagged = exports["qb-flags"]:HasPedFlag(tPed, "isGagged")
...
--   local gagtask = exports["qb-taskbar"]:taskBar(time, string)

--   if gagtask == 100 then
--     if isGagged then
--       exports['qb-flags']:SetPedFlag(tPed, 'isGagged', false)
--     else
--       exports['qb-flags']:SetPedFlag(tPed, 'isGagged', true)
--     end
--   end
