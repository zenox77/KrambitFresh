RegisterNetEvent('qb-bikerent:menu')
AddEventHandler('qb-bikerent:menu', function()                           
...
RegisterNetEvent('qb-bikerent:checkmoney')
AddEventHandler('qb-bikerent:checkmoney', function(data)                            
        local vehicle = data.car
        local price = data.price
        TriggerServerEvent("qb-bikerent:hasmoney", price, vehicle)

end)

RegisterNetEvent('qb-bikerent:spawnbike')
AddEventHandler('qb-bikerent:spawnbike', function(vehicleName)                            
