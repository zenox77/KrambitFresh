...
RPC.register("qb-business:startPurchase", function(pSource, pData)
    ...
    TriggerClientEvent("qb-business:activePurchase", -1, insert)
end)
...
RPC.register("qb-business:completePurchase", function(pSource, pData)
    ...
    local owner = exports["qb-base"]:getModule("Player"):GetUser(data.charger)
    ...
    TriggerClientEvent("qb-business:closePurchase", -1, insert)

    TriggerClientEvent('qb-phone:businessRegisterNoti', pSource, "SERVICE CHARGE", message)
