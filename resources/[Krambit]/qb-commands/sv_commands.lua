...
AddEventHandler("commands:player:login",function()
    ...
    TriggerClientEvent("chat:addSuggestion", src, "/racecreate", "Create a race")
    TriggerClientEvent("chat:addSuggestion", src, "/hud", "Open HUD options")
    TriggerClientEvent("chat:addSuggestion", src, "/ui-r", "Restarts UI (User Interface)")
    TriggerClientEvent(
