...
RegisterNetEvent("qb-dirtymoney:allowDirtyMoneyDrops")
AddEventHandler("qb-dirtymoney:allowDirtyMoneyDrops", function()
...
RegisterNetEvent("qb-dirtymoney:attemptDirtyMoneyDrops")
AddEventHandler("qb-dirtymoney:attemptDirtyMoneyDrops", function()
	if DropOffTime == 0 then
		TriggerEvent('qb-dirtymoney:allowDirtyMoneyDrops')
		--TriggerServerEvent('mobdelivery:checkjob')
		--TriggerServerEvent("qb-dirtymoney:alterDirtyMoney", "TurnToCash", 0)
	else
...
if DirtyMoney >= amount then
	local pos = GetEntityCoords(PlayerPedId())
		...
		TriggerServerEvent("qb-dirtymoney:alterDirtyMoney","ItemDrop",amount)
