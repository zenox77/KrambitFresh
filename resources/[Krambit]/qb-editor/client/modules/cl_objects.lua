...
RegisterNetEvent("qb-editor:buildName")
AddEventHandler("qb-editor:buildName", function(name, objects)
    if objects then
...
RegisterNetEvent("qb-editor:destroyName")
AddEventHandler("qb-editor:destroyName", function(name)
    cleanUpArea(name)
