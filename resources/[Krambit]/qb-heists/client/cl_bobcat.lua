...
RegisterNetEvent('qb-bobcat:firstdoor')
AddEventHandler('qb-bobcat:firstdoor', function()
    ...
    if pd >= 0 then
        if distance < 1.5 then
            if exports["qb-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                frontdoor()
                TriggerServerEvent('qb-heists:bobcatLog')
                TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                exports['qb-thermite']:OpenThermiteGame(function(success)
                    if success then
                        TriggerServerEvent('qb-doors:change-lock-state', 272, false) 
                        TriggerServerEvent("qb-doors:change-lock-state", 273, false)
                        exports["qb-dispatch"]:dispatchadd('10-90', "Bobcat Security Robbery", "500")
...
RegisterNetEvent('qb-bobcat:seconddoor')
AddEventHandler('qb-bobcat:seconddoor', function()
local player = GetEntityCoords(PlayerPedId())
        ...
        if exports["qb-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                ...
                exports['qb-thermite']:OpenThermiteGame(function(success)
                    if success then
                        ...
                        --Door IDS
                        TriggerServerEvent("qb-doors:change-lock-state", 274, false)
                        exports["qb-dispatch"]:dispatchadd('10-90', "Bobcat Security Robbery", "500")
                        Citizen.Wait(3000)
                    else
                        Citizen.Wait(2000)
...
RegisterNetEvent('qb-heists:bobcat_armed_door')
AddEventHandler('qb-heists:bobcat_armed_door', function()
    ...
    if pd >= 0 then
        if Dist < 1.5 then
            ...
            TriggerEvent('qb-heists:bobcat_explosion_ped')
            TriggerServerEvent('qb-heists:spawnpeds')
            FreezeEntityPosition(PlayerPedId(), true)
            FreezeEntityPosition(PlayerPedId(), false)
            TriggerServerEvent("qb-doors:change-lock-state", 276, false)
            TriggerServerEvent("qb-doors:change-lock-state", 277, false)
        end
    else
        TriggerEvent('DoLongHudText', 'Not enough cops on duty', 2)
    end
...
RegisterNetEvent("bobcat:success:panel", function()
    TriggerEvent('DoLongHudText', "Success!", 1)
    TriggerServerEvent("qb-doors:change-lock-state", 275, false)
    TriggerServerEvent("qb-doors:change-lock-state", 276, false)
    exports["qb-dispatch"]:dispatchadd('10-90', "Bobcat Security Robbery", "500")
end)
...
-- RegisterCommand('test24', function ()
-- TriggerEvent('ghost:bobcatcreateped')
-- end)

RegisterNetEvent('ghost:bobcatcreateped')
AddEventHandler('ghost:bobcatcreateped', function()
	...
	ped = CreatePed(pedType, hashKey, 4214.9169, -4591.208, 4.1845169, 75.648933, true, false)  
...
RegisterNetEvent('qb-bobcat:bubbles')
...
RegisterNetEvent('blow_door', function()
    TriggerServerEvent('qb-heists:bobcatLog')
    TriggerServerEvent('qb-bobcat:blow_door')
end)

RegisterNetEvent('qb-heists:bobcat_explosion_ped')
AddEventHandler('qb-heists:bobcat_explosion_ped', function()
...
RegisterNetEvent('qb-heists:explosion_ped_walk') -- PED WALK
AddEventHandler('qb-heists:explosion_ped_walk', function()
    exports["qb-dispatch"]:dispatchadd('10-90', "Bobcat Security Robbery", "500")
...
AddEventHandler('lumo:client:requestblast', function()
	TriggerServerEvent("qb-bobcat:request_door")
end)
...
AddEventHandler('lumo:pedbomb', function()
    ...
    TriggerServerEvent("qb-bobcat:bubbles")
    -- TriggerEvent("lumo:propcreate")
    Wait(1500)
end)


RegisterNetEvent('qb-bobcat:search_crate_1unchecked') -- PED WALK
AddEventHandler('qb-bobcat:search_crate_1unchecked', function()
    TriggerServerEvent("qb-bobcat:search_crate_1")
end)

RegisterNetEvent('qb-bobcat:search_crate_2unchecked') -- PED WALK
AddEventHandler('qb-bobcat:search_crate_2unchecked', function()
    TriggerServerEvent("qb-bobcat:search_crate_2")
end)

RegisterNetEvent('qb-bobcat:search_crate_3unchecked') -- PED WALK
AddEventHandler('qb-bobcat:search_crate_3unchecked', function()
    TriggerServerEvent("qb-bobcat:search_crate_3")
end)

RegisterNetEvent('qb-bobcat:search_crate_1') 
AddEventHandler('qb-bobcat:search_crate_1', function()
    FreezeEntityPosition(GetPlayerPed(-1),true)
    TriggerEvent("doAnim","search")
    exports["qb-dispatch"]:dispatchadd('10-90', "Bobcat Security Robbery", "500")
    local finished = exports["qb-taskbar"]:taskBar(30000,"Looting")
    if finished == 100 then
        TriggerEvent('qb-heists:bobcat_loot')
...
RegisterNetEvent('qb-bobcat:search_crate_2') 
...
RegisterNetEvent('qb-bobcat:search_crate_3')
...
RegisterNetEvent('qb-heists:bobcat_loot')
AddEventHandler('qb-heists:bobcat_loot', function()
...
RegisterNetEvent("ghost:ptfxparticle")
...
AddEventHandler("qb-inventory:itemUsed", function(item)
    if item == "thermitecharge" then
        TriggerEvent('qb-bobcat:firstdoor')
        TriggerEvent('qb-bobcat:seconddoor') 
    end
end)

AddEventHandler("qb-inventory:itemUsed", function(item)
    if item == "bobcatsecuritycard" then
        TriggerEvent('qb-heists:bobcat_armed_door')
    end
end)
...
exports["qb-polytarget"]:AddCircleZone("np_bobcat_loot_1",  vector3(886.61, -2287.32, 29.92), 1.0, {
    useZ = true,
})

exports["qb-polytarget"]:AddCircleZone("np_bobcat_loot_3",  vector3(881.4, -2282.62, 30.42), 1.0, {
    useZ = true,
})

exports["qb-polytarget"]:AddCircleZone("np_bobcat_loot_2",  vector3(882.49, -2286.17, 30.37), 1.0, {
    useZ = true,
})

exports["qb-interact"]:AddPeekEntryByPolyTarget('np_bobcat_loot_1', {{
    id = "np_bobcat_loot_1",
    event = "qb-bobcat:search_crate_1unchecked",
    icon = "circle",
    label = "Loot!",
    paramers = {},
}}, { distance = { radius = 3.5 }  })

exports["qb-interact"]:AddPeekEntryByPolyTarget('np_bobcat_loot_2', {{
    id = "np_bobcat_loot_2",
    event = "qb-bobcat:search_crate_2unchecked",
    icon = "circle",
    label = "Loot!",
    paramers = {},
}}, { distance = { radius = 3.5 }  })

exports["qb-interact"]:AddPeekEntryByPolyTarget('np_bobcat_loot_3', {{
    id = "np_bobcat_loot_3",
    event = "qb-bobcat:search_crate_3unchecked",
    icon = "circle",
    label = "Loot!",
    paramers = {},
}}, { distance = { radius = 3.5 }  })
