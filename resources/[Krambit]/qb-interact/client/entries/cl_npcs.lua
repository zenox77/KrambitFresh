    ...
    data = {
        {
            ...
            icon = "fas fa-circle",
            event = "qb-license:purchaseBusinessLicense",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "qb-meth:purchaseMethLabKey",
        }
    },
    options = {
        distance = { radius = 1.5 },
    ...
    data = {
        {
            ...
            label = "Open Shop",
            icon = "circle",
            event = "qb-npcs:ped:openDigitalDenShop",
        }
    },
    options = {
        distance = { radius = 2.5 },
    ...
    data = {
        {
            ...
            label = "Trade",
            icon = "recycle",
            event = "qb-npcs:ped:exchangeRecycleMaterial",
            parameters = {}
        }
    },
    options = {
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(entity)
            return not IsPedAPlayer(entity) and exports["qb-polyzone"]:IsInsideEvent(entity)
        end
    }
}
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "qb-houserobberies:sell_goods",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "qb-heists:interactBobcatC4Npc",
            parameters = {},
        },
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "qb-npcs:ped:giveStolenItems",
            parameters = {}
        },
        {
            id = "pawn_sell_items",
            ...
            icon = "circle",
            event = "qb-npcs:ped:sellStolenItems",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
      {
          ...
          label = "Buy Chips",
          icon = "fas fa-circle",
          event = "qb-casino:purchaseChipsAction",
          parameters = { "purchase" }
      },
      {
  ...
  data = {
    {
        ...
        icon = "fas fa-circle",
        event = "qb-casino:wheel:toggleEnable",
    },
    {
        id = "casino_wheel_spin_npc_spin",
        label = "Spin Wheel! ($500)",
        icon = "dollar-sign",
        event = "qb-casino:wheel:spinWheel",
    },
  },
  options = {
      distance = { radius = 2.5 },
  ...
  data = {
    {
        ...
        icon = "fas fa-circle",
        event = "qb-casino:purchaseMembershipCard",
        parameters = {}
    },
  },
  options = {
  ...
  data = {
    {
        ...
        icon = "fas fa-circle",
        event = "qb-casino:purchaseDrinks",
        parameters = {}
    },
  },
  options = {
    ...
    data = {
      {
          ...
          icon = "fas fa-clock",
          event = "qb-heists:checkAvailability",
          parameters = {}
      },
    },
    options = {
    ...
    data = {
      {
          ...
          event = "qb-heists:purchaseHeistEquipment",
          parameters = {}
      },
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Rent a Boat",
            icon = "circle",
            event = "qb-fishing:rentBoat",
        },
        {
            id = "fish_return",
            label = "Return the Boat",
            icon = "circle",
            event = "qb-fishing:returnBoat",
        }
    },
    options = {
        distance = { radius = 3.0 }
    ...
    data = {
        {
            ...
            label = "Get a Boat",
            icon = "circle",
            event = "qb-scuba:checkAndTakeDepo",
        }
    },
    options = {
        distance = { radius = 3.0 }
    ...
    data = {
        {
            ...
            label = "Pet",
            icon = "fas fa-circle",
            event = "qb-interact:doPettingAnimal",
            key = {},
        },
    },
    options = {
