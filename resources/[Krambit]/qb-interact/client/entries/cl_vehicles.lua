    ...
    data = {
        {
            ...
            icon = "cut",
            event = "qb-miscscripts:carBombs:removeBomb",
            parameters = {}
        },
    },
    options = {
        distance = { radius = 1.8 },
        isEnabled = function(pEntity, pContext)
            return exports['qb-carbombs']:isThisVehicleABomb(NetworkGetNetworkIdFromEntity(pEntity))
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        distance = { radius = 1.8 },
        isEnabled = function(pEntity, pContext)
            return exports['qb-activities']:canHandOffPackages() and exports['qb-inventory']:hasEnoughOfItem('darkmarketpackage', 1)
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            return exports['qb-fuel']:hasNozle()
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            ...
            and exports["qb-inventory"]:hasEnoughOfItem("fakeplate", 1, false)
            and not exports["qb-vehicles"]:GetVehicleMetadata(pEntity, 'fakePlate')
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            ...
            and exports["qb-vehicles"]:GetVehicleMetadata(pEntity, 'fakePlate')
        end
    }
}
...
--             icon = "car-crash",
--             event = 'qb-carscrap:ScrapVehicle',
--             parameters = {}
--         }
--     },
--     options = {
--         distance = { radius = 3.0 },
--         isEnabled = function(pEntity, pContext)
--             return exports['qb-carscrap']:InScrapLocation()
--         end
--     }
-- }
...
--             label = "Chop vehicle",
--             icon = "car-crash",
--             event = 'qb-carscrap:StartCarScrappingProcess',
--             parameters = {}
--         }
--     },
--     options = {
--         distance = { radius = 3.0 },
--         isEnabled = function(pEntity, pContext)
--             return exports['qb-carscrap']:InNormalScrapLocation()
--         end
--     }
-- }
    ...
    data = {
        {
            ...
            label = "Scratch Vin",
            icon = "eye-slash",
            event = "qb-boosting:finish_scratch",
            parameters = {}
        }
    },
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            return (not (isCloseToHood(pEntity, PlayerPedId()) or isCloseToBoot(pEntity, PlayerPedId(), 2.0, pContext.model))
              or pContext.model == GetHashKey("emsnspeedo"))
              and not IsPedInAnyVehicle(PlayerPedId(), false)
              and NetworkGetEntityIsNetworked(pEntity) and exports['qb-boosting']:pCanFinishScratch()
        end
    }
}
    ...
    data = {
        {
            ...
            icon = "wheelchair",
            event = "qb:vehicle:wheelchair:control",
            parameters = {}
        }
    },
    options = {
