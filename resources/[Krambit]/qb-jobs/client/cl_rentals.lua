...
local function returnBoat()
    ...
    local finished = exports["qb-taskbar"]:taskBar(1000, "Returning Boat")
    ...
    TriggerEvent("qb-fishing:currentlyRentedBoat", currentlyRentedBoat)
end

function rentBoat()
    boatsValeted = boatsValeted + 1
    FreezeEntityPosition(PlayerPedId(), true)
    local finished = exports["qb-taskbar"]:taskBar(1000, "Valeting Boat")
...
AddEventHandler("qb-fishing:rentBoat", function(name)
...
AddEventHandler("qb-fishing:returnBoat", function()
