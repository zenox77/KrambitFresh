...
RegisterNetEvent("attemt:play:song", function()
    local pUrl = exports["qb-applications"]:KeyboardInput({
        header = "Place the song URL below.",
        rows = {
            {
                id = 0,
    ...
    elseif pUrl[2].input then
        ...
        TriggerEvent("qb-musicplayer:stateSound", "volume", data)
