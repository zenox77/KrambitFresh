...
RegisterNUICallback("qb-ui:pingSend", function(data, cb)
...
RegisterNUICallback("qb-ui:pingAccept", function(data, cb)
...
RegisterNUICallback("qb-ui:pingReject", function(data, cb)
