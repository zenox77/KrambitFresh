...
Citizen.CreateThread(function()
    ...
    while(true) do
		...
		if addedPolyZone == false then
			    exports["qb-polyzone"]:AddBoxZone("carrent", vector3(110.4619140625, -1090.6267089844, 29.302474975586), 0.8, 0.9, {
				name="carrent",
				heading=331.47,
				debugPoly=false,
				minZ=22.37,
...
--RegisterNetEvent('qb-carrent:menu')
--AddEventHandler('qb-carrent:menu', function()   
...
RegisterNetEvent('qb-carrent:checkmoney')
AddEventHandler('qb-carrent:checkmoney', function(data)                            
        local vehicle = data.car
        local price = data.price
        TriggerServerEvent("qb-carrent:hasmoney", price, vehicle)

end)

RegisterNetEvent('qb-carrent:spawncar')
AddEventHandler('qb-carrent:spawncar', function(vehicleName)                            
