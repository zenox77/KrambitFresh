...
RegisterNetEvent('qb-rpc:cl_request')
AddEventHandler('qb-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('qb-rpc:cl_response', src, origin, callId, response)
end)