...
RegisterNetEvent("qb-scenes:allScenes")
AddEventHandler("qb-scenes:allScenes", function(scenes)
  activeScenes = scenes
end)

RegisterNetEvent("qb-scenes:refreshScenes")
AddEventHandler("qb-scenes:refreshScenes", function(sceneId, scene)
...
RegisterNetEvent("qb-scenes:deleteScene")
AddEventHandler("qb-scenes:deleteScene", function(removeId)
  if removeId then
...
function calculateScenesToDraw()
  ...
  local isPeekActive = exports['qb-interact']:IsPeeking()
...
RegisterInterfaceCallback("qb-ui:scenes:input", function(data, cb)
...
RegisterCommand("+startScene", function()
  if sceneStarted then
    ...
    exports['qb-interface']:openApplication('textbox', {
      callbackUrl = 'qb-ui:scenes:input',
      key = 1,
      items = {
        {
          icon = "pencil-alt",
...
RegisterCommand("+deleteScene", function()
  ...
  TriggerServerEvent("qb-scenes:deleteScene", GetEntityCoords(PlayerPedId()))
end, false)
RegisterCommand("-deleteScene", function() end, false)

Citizen.CreateThread(function()
  exports["qb-keybinds"]:registerKeyMapping("", "Scenes", "Start / Place Scene", "+startScene", "-startScene")
  exports["qb-keybinds"]:registerKeyMapping("", "Scenes", "Enable / Disable", "+enableScene", "-enableScene")
  exports["qb-keybinds"]:registerKeyMapping("", "Scenes", "Delete Closest Scene", "+deleteScene", "-deleteScene")
  RequestStreamedTextureDict('commonmenu', true)
  Wait(5000)
  TriggerServerEvent("qb-scenes:getScenes")
end)