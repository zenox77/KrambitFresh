...
AddEventHandler('qb-config:configReady', function()
    loadPublicData()
end)

function loadPublicData()
    local showWatermark = exports['qb-config']:GetMiscConfig('hud.watermark')
    local showroomPurchase = exports['qb-config']:GetMiscConfig('showrooms.catalog.purchase')
    local skipMdwProfileCheck = exports['qb-config']:GetMiscConfig('mdw.profiles.skip')
    local serverCode = exports["qb-config"]:GetServerCode()
...
-- AddEventHandler("qb-ui:hud:values", function(values)
--   -- sendAppEvent("hud", {
--   --     food = values["hunger"],
