...
RegisterNUICallback("qb-ui:setKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
  -- data.value = value
  ...
  TriggerEvent("qb-hud:settings", data.key, data.value)
...
RegisterNUICallback("qb-ui:getKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
...
function GetPreferences()
  local result = GetResourceKvpString('qb-preferences')
  return json.decode(result or "{}")
end
