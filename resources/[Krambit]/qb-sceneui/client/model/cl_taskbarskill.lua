...
function taskBarSkillCheck(difficulty, skillGapSent, cb, reverse, usePrev)
  ...
  local duration = difficulty * (math.min(exports["qb-buffs"]:getAlertLevelMultiplier(), 1.33))
  ...
  exports['qb-actionbar']:disableActionBar(true)
  ...
  SetTimeout(500, function()
    if not tbsListening then
      exports['qb-actionbar']:disableActionBar(false)
