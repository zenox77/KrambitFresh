...
RegisterNetEvent('ghost_spray:spray')
AddEventHandler('ghost_spray:spray', function(text)
...
function PersistSpray()
    ...
    if rayEndCoords and rayNormal then
        ...
        local finished = exports["qb-taskbar"]:taskBar(10000, "Spraying..", false, true, false, false, nil, 5.0, PlayerPedId())
        if finished == 100 then
            TriggerServerEvent('ghost_spray:addSpray', {
