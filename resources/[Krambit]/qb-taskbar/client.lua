...
function handheld() 
  ...
  function generalInventory()
    if not insidePrompt and not inventoryDisabled and not forceInventoryDisabled and not exports['qb-taskbar']:pInInv() then
  ...
  local function hasPhone()
    return exports["qb-inventory"]:hasEnoughOfItem("mobilephone", 1, false, true) or
        exports["qb-inventory"]:hasEnoughOfItem("stoleniphone", 1, false, true) or
        exports["qb-inventory"]:hasEnoughOfItem("stolens8", 1, false, true) or
        exports["qb-inventory"]:hasEnoughOfItem("stolennokia", 1, false, true) or
        exports["qb-inventory"]:hasEnoughOfItem("stolenpixel3", 1, false, true) or
        exports["qb-inventory"]:hasEnoughOfItem("boomerphone", 1, false, true)
  end
  ...
  function generalPhone()
    if not insidePrompt and hasPhone() and canUsePhone() then
      ...
      -- exports["qb-ui"]:openApplication("phone", {
...
Citizen.CreateThread(function()
    exports["qb-keybinds"]:registerKeyMapping("", "Radio", "Open", "+handheld", "-handheld", "I")
    RegisterCommand('+handheld', handheld, false)
    RegisterCommand('-handheld', function() end, false)
    
    exports["qb-keybinds"]:registerKeyMapping("", "Phone", "Open", "+generalPhone", "-generalPhone", "P")
    RegisterCommand('+generalPhone', generalPhone, false)
    RegisterCommand('-generalPhone', function() end, false)
    
    exports["qb-keybinds"]:registerKeyMapping("", "Inventory", "Open", "+generalInventory", "-generalInventory", "K")
    RegisterCommand('+generalInventory', generalInventory, false)
    RegisterCommand('-generalInventory', function() end, false)
    
    exports["qb-keybinds"]:registerKeyMapping("", "Player", "Escape menu", "+generalEscapeMenu", "-generalEscapeMenu", "ESCAPE")
