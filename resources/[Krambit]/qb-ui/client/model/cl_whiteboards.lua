...
Citizen.CreateThread(function()
   ...
   --[[  exports["qb-polyzone"]:AddPolyZone("ktown",
    {
   ...
   --[[  exports["qb-polytarget"]:AddBoxZone("screen01", vector3(-587.1, -1060.58, 24.20), 0.6, 0.25, {
        heading = 1,
        minZ = 23.54,
        maxZ = 24.47
    })

    exports["qb-interact"]:AddPeekEntryByPolyTarget("screen01", {{
...
AddEventHandler("qb-polyzone:enter", function(pZoneName, pZoneData)
    if pZoneName == "qb-police:zone" then
        if exports["qb-base"]:getChar("job") == pZoneData.job then
            ...
            exports["qb-interaction"]:showInteraction(zoneData[pZoneData.zone].promptText)
...
AddEventHandler("qb-polyzone:exit", function(pZoneName, pZoneData)
    if pZoneName == "qb-police:zone" then
        exports["qb-interaction"]:hideInteraction()
        listening = false
        currentPrompt = nil
    elseif pZoneName == "mrpd_classroom" then
...
AddEventHandler("qb-polce:changewhiteboardurl", function(pParams)
     exports['qb-interface']:openApplication('textbox', {
        callbackUrl = 'qb-ui:WhiteboardURL',
        key = 1,
        items = {
          {
            icon = "link",
...
RegisterInterfaceCallback('qb-ui:WhiteboardURL', function(data, cb)
...
AddEventHandler("police:changewhiteboardcli", function(pUrl, pRoom)
    ...
    --[[ elseif pRoom == "uwuscreenone" and inUwuCafe and dui then
        ...
        if inUwuCafe and dui then
            exports["qb-lib"]:changeDuiUrl(dui.id, uwuScreenOneBoardUrl)
        end ]]
