...
AddEventHandler('qb-voice:settingsCallback', function(cb)
	cb(Cfg)
end)
...
RegisterCommand('+cycleproximity', function()
	...
	TriggerEvent('qb-voice:setTalkingMode', voiceMode)
	TriggerEvent("qb-hud:changeRange", voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
...
RegisterNetEvent('qb-voice:toggleMute', toggleMute)
...
function setVoiceProperty(type, value)
	...
	elseif type == "micClicks" then
		...
		micClicks = val
		SetResourceKvp('qb-voice_enableMicClicks', val)
	end
end
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	local micClicksKvp = GetResourceKvpString('qb-voice_enableMicClicks')
	if not micClicksKvp then
		SetResourceKvp('qb-voice_enableMicClicks', tostring(true))
	else
