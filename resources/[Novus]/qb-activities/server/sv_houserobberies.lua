...
Citizen.CreateThread(function()
	...
	RPC.register('qb-houserobbery:enter_property', function(source, ...)
		local cb = {x,y,z,num}
		return cb
	end)	
...
RegisterServerEvent('qb-activities:givePayout')
AddEventHandler('qb-activities:givePayout', function(amount, pType, text)
    local src = source
