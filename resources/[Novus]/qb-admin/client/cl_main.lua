...
RegisterNetEvent('qb-admin:cl:fling-player', function()
...
RegisterNetEvent('qb-admin:cl:fart-noise',function(pTarget)
    TriggerServerEvent('qb-admin:server:play-sound',pTarget)
end)

RegisterNetEvent("qb-admin:cl:play-sound", function(Sound)
  TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 5, 'FartNoise2', 0.3)
end)

RegisterNetEvent("np:admin/client/select-spawn", function()
...
AddEventHandler("np:admin:ReviveInDistance", function()
    ...
    for index,value in ipairs(players) do
        ...
        if(distance < 50) then
            TriggerServerEvent('np:admin:revive_in_distance')
...
Citizen.CreateThread( function()
  ...
  function getVehiclesCombined() 
    ...
    local vehicleTable = exports['qb-admin']:getVehicles()
    local addonVehicleTable = exports['qb-admin']:getAddonVehicles()
  ...
  RegisterNetEvent('qb-admin:InsertPrioCL')
  AddEventHandler('qb-admin:InsertPrioCL', function()
    TriggerServerEvent('qb-admin:insertPrio')
  end)