...
local count = 0
RegisterNetEvent("np:admin/server/ban-player", function(ServerId, Expires, Reason)
    ...
    DropPlayer(ServerId,
        "You are banned, you may appeal it at https://discord.gg/nopixel.net | Ban ID: " .. banId .. " | Reason: " .. pReason ..
            " | Unban Date: " .. unbanDate)
end)

local count = 0

RegisterNetEvent("np:admin:unBan", function(pBanID)
    print('UnBanning ID: ',pBanID)
    local src = source
