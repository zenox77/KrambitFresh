...
function DPX.DataControls.setBindTable(controlTable,shouldSend)
	if controlTable == nil then
		...
		TriggerServerEvent('qb-base:sv:player_control_set',DPX.Controls.Current)
...
RegisterNetEvent("qb-base:cl:player_control")
AddEventHandler("qb-base:cl:player_control", function(controlTable)
...
RegisterNetEvent('qb-base:setcontrols')
AddEventHandler('qb-base:setcontrols', function()
	TriggerServerEvent('qb-base:sv:player_controls')
end)
