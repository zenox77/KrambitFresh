...
local function AddMethod(player)
    ...
    function player.networkVar(self, var, data)
        ...
        TriggerClientEvent("qb-base:networkVar", GetUser(self):getVar("source"), var, data)
    end
...
local pos = {}
RegisterServerEvent('qb-base:updatecoords')
AddEventHandler('qb-base:updateCoords', function(x,y,z)
    local src = source
    pos[src] = {x,y,z}
end)
...
AddEventHandler("playerDropped", function(reason)
    ...
    TriggerEvent('qb-base:playerDropped', src, user)
end)
...
RegisterServerEvent('qb-base:logDeath')
AddEventHandler('qb-base:logDeath', function(killer, reason)
    local src = source
    ...
    local connect = {
        {
          ["color"] = color,
          ["title"] = "** FM | Nopixel [qb-base] | Death Log **",
