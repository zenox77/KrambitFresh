...
function DPX.SpawnManager.InitialSpawn(self)
    Citizen.CreateThread(function()
        ...
        if new then TriggerEvent("qb-base:newCharacterSpawned") DoScreenFadeIn(500) end
...
-- RegisterNetEvent("qb-base:newCharacterSpawned")
-- AddEventHandler('qb-base:newCharacterSpawned', function()
--     DestroyAllCams(true)
--     TriggerEvent("raid_clothes:defaultReset")
--     FreezeEntityPosition(PlayerPedId(), false)
-- end)

RegisterNetEvent("qb-base:firstSpawn")
