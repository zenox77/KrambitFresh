...
RegisterNetEvent("qb-heists:cocaine:failure")
AddEventHandler("qb-heists:cocaine:failure", function ()
...
RegisterNetEvent("qb-heists:cocaine:begin_start")
AddEventHandler("qb-heists:cocaine:begin_start", function ()
    print('Here 3')
...
RegisterNetEvent("qb-heists:cocaine:success:2")
AddEventHandler("qb-heists:cocaine:success:2", function ()
    print('Here 2')
    if not enabled or not eventStarted then
        return
    end
...
RegisterNetEvent("qb-heists:cocaine:success:3")
AddEventHandler("qb-heists:cocaine:success:3", function ()
    print('Here 1')
    if not enabled or not eventStarted then
        return
    end
...
RegisterNetEvent("qb-heists:cocaine:success:4")
AddEventHandler("qb-heists:cocaine:success:4", function ()
...
Citizen.CreateThread(function()
    ...
    -- START EVENT
    exports["qb-polytarget"]:AddBoxZone(
    ...
    exports["qb-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall', {{
        event = "qb-heists:cocaine:failure",
    ...
    exports["qb-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall', {{
        event = "qb-heists:cocaine:begin_start",
    ...
    exports["qb-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_second', {{
        event = "qb-heists:cocaine:success:2",
    ...
    exports["qb-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_third', {{
        event = "qb-heists:cocaine:success:3",
    ...
    exports["qb-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_four', {{ -- THIS IS FUCKING SUCCESSSSSSSS
        event = "qb-heists:cocaine:success:4",
    ...
    exports["qb-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_four', {{
        event = "qb-heists:cocaine:success:4",
...
RegisterNetEvent("qb-heists:doVehicle", function(pVehicle, x,y,z)
    print(pVehicle)
...
RegisterCommand('cocaine', function()
    ...
    Wait(5500)
    TriggerEvent('qb-heists:cocaine:success:4')
end)