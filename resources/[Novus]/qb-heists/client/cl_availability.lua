RegisterNetEvent('qb-heists:checkAvailability')
AddEventHandler('qb-heists:checkAvailability', function() 
    ...
    exports["qb-interface"]:showContextMenu(FatCunt)
end)

RegisterNetEvent('qb-heists:purchaseHeistEquipment')
AddEventHandler('qb-heists:purchaseHeistEquipment', function()
    local HeistEquipment = {
		{
            ...
            children = {
                ...
                action = "qb-heists:purchaseGreenLaptop",
            },
        },
        {
            title = "Paleto Laptop",
            ...
            children = {
                ...
                action = "qb-heists:purchaseBlueLaptop",
            },
        },
    }
...
RegisterInterfaceCallback('qb-heists:purchaseGreenLaptop', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    if exports['qb-inventory']:hasEnoughOfItem('heistusb5', 1) then
        TriggerEvent('inventory:removeItem', 'heistusb5', 1)
        TriggerEvent("player:receiveItem", "heistlaptop3", 1)
    end
end)

RegisterInterfaceCallback('qb-heists:purchaseBlueLaptop', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    if exports['qb-inventory']:hasEnoughOfItem('heistusb1', 1) then
