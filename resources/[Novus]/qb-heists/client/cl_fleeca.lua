...
RegisterInterfaceCallback('qb-fleeca:email_1', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('ghost:bankemail1')
end)

RegisterNetEvent("ghost:bankemail1", function()
...
RegisterInterfaceCallback('qb-fleeca:email_2', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('ghost:bankemail2')
end)

RegisterNetEvent("ghost:bankemail2", function()
...
RegisterInterfaceCallback('qb-fleeca:email_3', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('ghost:bankemail3')
end)

RegisterNetEvent("ghost:bankemail3", function()
...
RegisterInterfaceCallback('qb-fleeca:email_4', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('ghost:bankemail5')
end)

RegisterNetEvent("ghost:bankemail5", function()
...
RegisterInterfaceCallback('qb-fleeca:email_5', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('ghost:bankemail6')
end)

RegisterNetEvent("ghost:bankemail6", function()
...
RegisterInterfaceCallback('qb-fleeca:email_6', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('ghost:bankemail7')
end)

RegisterNetEvent("ghost:bankemail7", function()
...
RegisterNetEvent("ghost:bankemail", function(bankname)
    local username = "FLEECA"..(math.random (10000,99999))
    local password = math.random (1000000,9999999)

    TriggerServerEvent('ghost:usernamestore', bankname, username, password)

    TriggerServerEvent('ghost:fleecalogin', bankname, username, password)
...
RegisterNetEvent('qb-robbery:usb')
AddEventHandler('qb-robbery:usb', function()
    local ped = GetPlayerPed(-1)
    local pos = GetEntityCoords(ped)
            ...
            if closestBank ~= nil then
                ...
                if dist < 1.5 then				
                    if not Config.SmallBanks[closestBank]["isOpened"] then 
                        if Police >= 1 then
                            TriggerServerEvent('qb-heists:fleecaBankLog')
                            TriggerServerEvent("qb-heists:availabilty")
                            exports["qb-dispatch"]:dispatchadd('10-90', "Fleeca Bank Robbery", "108")
                            TriggerServerEvent('ghost:retrievelogindata', closestBank)
                            TriggerEvent("client:newStress",true,30)
                            FreezeEntityPosition(GetPlayerPed(-1), false)
                            StartHeistFleecaPanel()
                            Citizen.Wait(5000)
                            exports['qb-hacking']:hacking(
                            function()
...
RegisterNetEvent('qb-robbery:client:setBankState')
AddEventHandler('qb-robbery:client:setBankState', function(bankId, state)
...
RegisterNetEvent('qb-robbery:client:enableAllBankSecurity')
AddEventHandler('qb-robbery:client:enableAllBankSecurity', function()
    for k, v in pairs(Config.SmallBanks) do
        Config.SmallBanks[k]["alarm"] = true
    end
end)

RegisterNetEvent('qb-robbery:client:disableAllBankSecurity')
AddEventHandler('qb-robbery:client:disableAllBankSecurity', function()
    for k, v in pairs(Config.SmallBanks) do
        Config.SmallBanks[k]["alarm"] = false
    end
end)

RegisterNetEvent('qb-robbery:client:BankSecurity')
AddEventHandler('qb-robbery:client:BankSecurity', function(key, status)
...
RegisterNetEvent('qb-robbery:client:setLockerState')
AddEventHandler('qb-robbery:client:setLockerState', function(bankId, lockerId, state, bool)
    if bankId == "pacific" then	
        print('[QUEER]')
    else
...
RegisterNetEvent('qb-robbery:client:ResetFleecaLockers')
AddEventHandler('qb-robbery:client:ResetFleecaLockers', function(BankId)
...
RegisterNetEvent("fleeca:success:panel", function()
    ...
    exports["qb-dispatch"]:dispatchadd('10-90', "Fleeca Bank Robbery", "108")
    TriggerServerEvent('qb-robbery:server:setBankState', closestBank, true)

     if closestBank == 1 then
        print('[qb-heists] CREATE FLEECA PINK CAGE TROLLEYS')
        TriggerEvent('qb:create:props:trolleys:pink:cage:bank')
     elseif closestBank == 2 then
        print('[qb-heists] CREATE FLEECA LEGION SQUARE TROLLEYS')
        TriggerEvent('qb:create:props:trolleys:legion:sqaure:bank')
     elseif closestBank == 3 then
        print('[qb-heists] CREATE FLEECA HAWICK AVE TROLLEYS')
        TriggerEvent('qb:create:props:trolleys:hawick:ave:bank')
     elseif closestBank == 4 then
        print('[qb-heists] CREATE FLEECA DEL PERRO TROLLEYS')
        TriggerEvent('qb:create:props:trolleys:del:perrro:blvd')
     elseif closestBank == 5 then
        print('[qb-heists] CREATE FLEECA GREAT OCEAN TROLLEYS')
        TriggerEvent('qb:create:props:trolleys:great:ocean:highway')
     elseif closestBank == 6 then
        print('[qb-heists] CREATE FLEECA ROUTE 68 TROLLEYS')
        TriggerEvent('qb:create:props:trolleys:route:68:bank')
     end
     DeleteObject(laptop)
 end)
...
AddEventHandler("fleeca:loot", function()
    local card = exports["qb-taskbar"]:taskBar(40000,"Taking cash...")
    if card == 100 then
...
RegisterNetEvent('qb:create:props:trolleys:legion:sqaure:bank')
AddEventHandler('qb:create:props:trolleys:legion:sqaure:bank', function()
...
RegisterNetEvent('qb:create:props:trolleys:del:perrro:blvd')
AddEventHandler('qb:create:props:trolleys:del:perrro:blvd', function()
...
RegisterNetEvent('qb:create:props:trolleys:great:ocean:highway')
AddEventHandler('qb:create:props:trolleys:great:ocean:highway', function()
...
RegisterNetEvent('qb:create:props:trolleys:pink:cage:bank')
AddEventHandler('qb:create:props:trolleys:pink:cage:bank', function()
...
RegisterNetEvent('qb:create:props:trolleys:hawick:ave:bank')
AddEventHandler('qb:create:props:trolleys:hawick:ave:bank', function()
...
RegisterNetEvent('qb:create:props:trolleys:route:68:bank')
AddEventHandler('qb:create:props:trolleys:route:68:bank', function()
...
RegisterNetEvent("qb-fleeca:grab")
AddEventHandler("qb-fleeca:grab", function()
