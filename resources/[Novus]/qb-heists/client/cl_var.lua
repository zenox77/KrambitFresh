RegisterNetEvent('qb-heists:door_thermite')
AddEventHandler('qb-heists:door_thermite', function()
    TriggerServerEvent('qb-heists:thermite_var')
end)

RegisterNetEvent('qb-heists:var_door_to_lobby')
AddEventHandler('qb-heists:var_door_to_lobby', function()
    local player = GetEntityCoords(PlayerPedId())
    local distance = #(vector3(-209.2301, -303.5382, 74.482246) - player)
    if distance < 1.5 then
        if exports["qb-inventory"]:hasEnoughOfItem("thermal_charge", 1) then
            TriggerEvent('qb-hud:show_hackerman')
            LobbyDoor()
            exports['qb-thermite']:OpenThermiteGame(function(success)
                if success then
                    TriggerServerEvent('qb-heists:var_thermite')
                    TriggerEvent('qb-hud:hide_hackerman')
                    TriggerEvent("inventory:removeItem", "thermal_charge", 1)
                    TriggerServerEvent('qb-doors:change-lock-state', 573, false) 
                    Citizen.Wait(3000)
...
exports["qb-polytarget"]:AddCircleZone("var_computer_1",  vector3(-212.7, -298.21, 74.49), 0.35, {
    useZ = true
})

exports["qb-interact"]:AddPeekEntryByPolyTarget("var_computer_1", {
    {
        event = "qb-heists:var_event_1",
        id = "var_computer_1",
        icon = "user-secret",
...
RegisterNetEvent('qb-heists:var_event_1')
AddEventHandler('qb-heists:var_event_1', function()
    TriggerServerEvent('qb-heists:in_var_1_srv')
end)

RegisterNetEvent('qb-heists:enter_var_location_1')
AddEventHandler('qb-heists:enter_var_location_1', function()
    if exports['qb-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
...
exports["qb-polytarget"]:AddCircleZone("var_computer_2",  vector3(-211.2, -301.14, 74.49), 0.45, {
    useZ = true
})

exports["qb-interact"]:AddPeekEntryByPolyTarget("var_computer_2", {
    {
        event = "qb-heists:var_event_2",
        id = "var_computer_2",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('qb-heists:var_event_2')
AddEventHandler('qb-heists:var_event_2', function()
    TriggerServerEvent('qb-heists:in_var_2_srv')
end)

RegisterNetEvent('qb-heists:enter_var_location_2')
AddEventHandler('qb-heists:enter_var_location_2', function()
    if exports['qb-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["qb-polytarget"]:AddCircleZone("var_computer_3",  vector3(-206.6, -297.19, 74.49), 0.45, {
    useZ = true
})

exports["qb-interact"]:AddPeekEntryByPolyTarget("var_computer_3", {
    {
        event = "qb-heists:var_event_3",
        id = "var_computer_3",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('qb-heists:var_event_3')
AddEventHandler('qb-heists:var_event_3', function()
    TriggerServerEvent('qb-heists:in_var_3_srv')
end)

RegisterNetEvent('qb-heists:enter_var_location_3')
AddEventHandler('qb-heists:enter_var_location_3', function()
    if exports['qb-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["qb-polytarget"]:AddCircleZone("var_computer_4",  vector3(-207.02, -294.14, 74.49), 0.5, {
    useZ = true
})

exports["qb-interact"]:AddPeekEntryByPolyTarget("var_computer_4", {
    {
        event = "qb-heists:var_event_4",
        id = "var_computer_4",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('qb-heists:var_event_4')
AddEventHandler('qb-heists:var_event_4', function()
    TriggerServerEvent('qb-heists:in_var_4_srv')
end)

RegisterNetEvent('qb-heists:enter_var_location_4')
AddEventHandler('qb-heists:enter_var_location_4', function()
    if exports['qb-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["qb-polytarget"]:AddCircleZone("var_computer_5",  vector3(-209.4, -293.28, 74.49), 0.4, {
    useZ = true
})

exports["qb-interact"]:AddPeekEntryByPolyTarget("var_computer_5", {
    {
        event = "qb-heists:var_event_5",
        id = "var_computer_5",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('qb-heists:var_event_5')
AddEventHandler('qb-heists:var_event_5', function()
    TriggerServerEvent('qb-heists:in_var_5_srv')
end)

RegisterNetEvent('qb-heists:enter_var_location_5')
AddEventHandler('qb-heists:enter_var_location_5', function()
    if exports['qb-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
AddEventHandler('varhack:1', function()
    exports['qb-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('Karambitrp:varcreateped')
            TriggerServerEvent('qb-heists:hackfalse')
        else
            TriggerEvent('Karambitrp:varcreatepedfail1')
        end
      end, 8, 5)
end)
...
TriggerServerEvent('qb-heists:hack1')
end)


exports["qb-polytarget"]:AddCircleZone("var_hack1",  vector3(2167.94, 2925.92, -81.38), 0.5, {
    useZ = true
})


exports["qb-interact"]:AddPeekEntryByPolyTarget("var_hack1", {
    {
...
AddEventHandler('varhack:2', function()
    exports['qb-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('Karambitrp:varcreateped2')
            TriggerServerEvent('qb-heists:hackfalse2')
          print("working?")
        else
            TriggerEvent('Karambitrp:varcreatepedfail1')
          print("lol")
...
TriggerServerEvent('qb-heists:hack2')
end)

exports["qb-polytarget"]:AddCircleZone("var_hack2",  vector3(2135.66, 2901.72, -84.27), 0.53, {
    useZ = true
})


exports["qb-interact"]:AddPeekEntryByPolyTarget("var_hack2", {
    {
...
AddEventHandler('varhack:3', function()
    exports['qb-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('Karambitrp:varcreateped3')
            TriggerServerEvent('qb-heists:hackfalse3')
          print("working?")
        else
            TriggerEvent('Karambitrp:varcreatepedfail2')
          print("basarisiz")
        end
      end, 7, 6)
end)
...
TriggerServerEvent('qb-heists:hack3')
end)

exports["qb-polytarget"]:AddCircleZone("var_hack3",  vector3(2171.24, 2927.76, -81.38), 0.41, {
    useZ = true
})


exports["qb-interact"]:AddPeekEntryByPolyTarget("var_hack3", {
    {
...
AddEventHandler('varhack:4', function()
    exports['qb-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('Karambitrp:varcreateped')
            TriggerServerEvent('qb-heists:hackfalse4')
          print("working?")
        else
            TriggerEvent('Karambitrp:varcreatepedfail2')
          print("basarisiz")
...
TriggerServerEvent('qb-heists:hack4')
end)

exports["qb-polytarget"]:AddCircleZone("var_hack4",  vector3(2087.82, 2946.72, -84.22), 0.53, {
    useZ = true
})


exports["qb-interact"]:AddPeekEntryByPolyTarget("var_hack4", {
    {
...
AddEventHandler('varhack:5', function()
    exports['qb-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('Karambitrp:varcreateped2')
            TriggerServerEvent('qb-heists:hackfalse5')
          print("working?")
        else
            TriggerEvent('Karambitrp:varcreatepedfail')
          print("basarisiz")
        end
      end, 8, 7)
end)
...
TriggerServerEvent('qb-heists:hack5')
end)

exports["qb-polytarget"]:AddCircleZone("var_hack5",  vector3(2174.89, 2927.76, -81.38), 0.4, {
    useZ = true
})

exports["qb-interact"]:AddPeekEntryByPolyTarget("var_hack5", {
    {
...
AddEventHandler('varhack:6', function()
    exports['qb-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('qb-heists:hackfalse6')
          print("working?")
        else
            TriggerEvent('Karambitrp:varcreatepedfail')
          print("basarisiz")
...
TriggerServerEvent('qb-heists:hack6')
end)

exports["qb-polytarget"]:AddCircleZone("var_hack6",  vector3(2327.77, 2945.95, -84.47), 0.55, {
    useZ = true
})

exports["qb-interact"]:AddPeekEntryByPolyTarget("var_hack6", {
    {
...
AddEventHandler('varhack:7', function()
    exports['qb-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('Karambitrp:varcreateped2')
            TriggerServerEvent('qb-heists:hackfalse7')
...
if exports["qb-inventory"]:hasEnoughOfItem("varusb", 1) then
TriggerServerEvent('qb-heists:hack7')
end 
end)

exports["qb-polytarget"]:AddCircleZone("var_hack7",  vector3(2185.9, 2913.24, -84.8), 0.5, {
    useZ = true
})

exports["qb-interact"]:AddPeekEntryByPolyTarget("var_hack7", {
    {
...
AddEventHandler('varhack:8', function()
    exports['qb-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('Karambitrp:varcreateped')
            TriggerServerEvent('qb-heists:hackfalse8')
            TriggerEvent("inventory:removeItem", "varusb", 1)
...
if exports["qb-inventory"]:hasEnoughOfItem("varusb", 1) then
TriggerServerEvent('qb-heists:hack8')
end 
end)

exports["qb-polytarget"]:AddCircleZone("var_hack8",  vector3(2185.94, 2928.69, -84.8), 0.5, {
    useZ = true
})

exports["qb-interact"]:AddPeekEntryByPolyTarget("var_hack8", {
    {
...
exports["qb-polytarget"]:AddCircleZone("leave",  vector3(2156.4, 2922.22, -81.08), 0.5, {
    useZ = true
})

exports["qb-interact"]:AddPeekEntryByPolyTarget("leave", {
    {
...
TriggerServerEvent('qb-leavevar2')
end)

---- PEDS
RegisterNetEvent('Karambitrp:varcreateped')
AddEventHandler('Karambitrp:varcreateped', function()
...
RegisterNetEvent('Karambitrp:varcreateped2')
AddEventHandler('Karambitrp:varcreateped2', function()
    local hashKey = `s_m_y_swat_01`
...
RegisterNetEvent('Karambitrp:varcreateped3')
AddEventHandler('Karambitrp:varcreateped3', function()
    local hashKey = `s_m_y_swat_01`
...
RegisterNetEvent('Karambitrp:varcreatepedfail1')
AddEventHandler('Karambitrp:varcreatepedfail1', function()
    local hashKey = `s_m_y_swat_01`
...
RegisterNetEvent('Karambitrp:varcreatepedfail2')
AddEventHandler('Karambitrp:varcreatepedfail2', function()
    local hashKey = `s_m_y_swat_01`
...
AddEventHandler('exit:varcompleteheist', function()
  ...
  TriggerEvent('qb:admin:ReviveInDistance')
  Citizen.Wait(1000)
end)
...
RegisterNetEvent('qb-heists:loot_peds')
AddEventHandler('qb-heists:loot_peds', function()
...
RegisterNetEvent('qb-heists:var_loot_ped')
AddEventHandler('qb-heists:var_loot_ped', function()
    if isPlayerInVar == 1 then
        TriggerEvent('qb-heists:loot_peds')
        TriggerServerEvent('qb-var:lootcooldown')
    else
        print('cooldown')
    end
end)

RegisterNetEvent('qb-heists:svclientloot')
AddEventHandler('qb-heists:svclientloot', function()
    TriggerServerEvent('qb-evannicxvar:varlootcooldown')
end)

function removevarmedkits()
    local qty = exports["qb-inventory"]:getQuantity("varmedkit")
  ...
  function removevpistolammo()
    local qty = exports["qb-inventory"]:getQuantity("pistolammo")
    if qty and qty > 0 then
  ...
  function removevsubammo()
    local qty = exports["qb-inventory"]:getQuantity("subammo")
    if qty and qty > 0 then
  ...
  function removevrifleammo()
    local qty = exports["qb-inventory"]:getQuantity("rifleammo")
    if qty and qty > 0 then
