...
RegisterServerEvent('qb-heists:check_if_robbed')
AddEventHandler('qb-heists:check_if_robbed', function(license)
...
RegisterServerEvent('qb-heists:bankTruckLog')
AddEventHandler('qb-heists:bankTruckLog', function()
    local src = source
