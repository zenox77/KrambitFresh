...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            return not exports['qb-fuel']:hasNozle()
        end
    }
}
...
--             label = "Smoke Machine",
--             icon = "circle",
--             event = "qb-stripclub:smokemachine",
--             parameters = {}
--         }
--     },
--     options = {
  ...
  data = {
      {
          ...
          icon = "archive",
          event = "qb-beekeeping:checkBeehive",
          parameters = {}
      }
  },
  options = {
  ...
  data = {
      {
          ...
          event = "qb-beekeeping:harvestHive",
          parameters = {}
      }
  },
  options = {
