...
function RegisterInterfaceEvent(eventName)
...
exports('RegisterInterfaceEvent', RegisterInterfaceEvent)
...
RegisterNetEvent("qb-interface:open-application")
AddEventHandler("qb-interface:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("qb-interface:application-closed", app, { fromEscape = false })
end
...
RegisterNetEvent("qb-interface:soundPlay")
AddEventHandler("qb-interface:soundPlay", function(name, volume, loop)
