        ...
        var FT = function (SU) {
            ...
            return (
              Fl('uiMessage', function (ch) {
                ...
                'badge' === ch.app &&
                  ...
                  SQ(true),
                  setTimeout(function () {
                    Fd('qb-interface:closeApp', {}).then(function (cM) {
                      true === cM.meta.ok &&
                        Fd('qb-interface:applicationClosed', {
                          name: 'badge',
                          fromEscape: true,
                        }).then(function (cb) {
              ...
              Object(FG.jsx)(FG.Fragment, {
                children: Object(FG.jsx)('div', {
                  ...
                  children: Object(FG.jsx)('div', {
                    ...
                    style: {
                      backgroundImage:
                        'url(https://gta-assets.Karambit.net/images/dark_leather.png)',
                    },
                    children: Object(FG.jsx)('div', {
                            ...
                            children: Object(FG.jsx)('div', {
                              ...
                              children: Object(FG.jsx)('div', {
                                ...
                                children: Object(FG.jsx)('img', {
                                  alt: 'badge',
                                  className: 'badge',
                                  src: 'https://gta-assets.Karambit.net/images/badges/'.concat(
                                    void 0 !== cF ? cF : 'LSPD',
                                    '.png'
                                  ),
                                }),
            ...
            Object(F4.useEffect)(
              function () {
                var cm = function (cs) {
                  Fg.includes(cs.code) &&
                    ('eye' === cv
                      ? Fd('qb-interface:closeApp', {}).then(function (cR) {
                          true === cR.meta.ok &&
                            Fd('qb-interface:applicationClosed', {
                              name: 'eye',
                              fromEscape: true,
                      ...
                      : 'clothing' === cv && Fd('qb-clothing:attemptClose'))
                }
                return (
          ...
          Fp = function (SU) {
            ...
            var cr = function (cB, ch, cO, cP, cN, cJ) {
              ...
              void 0 !== cB
                ? (void 0 !== cO && false !== cO) ||
                  Fd('qb-interface:closeApp', {}).then(function (cb) {
                    true === cb.meta.ok &&
              ...
              Object(FG.jsx)(FG.Fragment, {
                children: Object(FG.jsxs)('div', {
                  ...
                  children: [
                    Object(FG.jsx)('img', {
                      src: c7
                        ? 'https://gta-assets.Karambit.net/images/peek-active-1.png'
                        : 'https://gta-assets.Karambit.net/images/peek.png',
                      alt: 'peek',
                      style: {
                        maxWidth: '2.5vw',
                        maxHeight: '2.5vw',
                                    ...
                                    Object(FG.jsx)(Ff.a, {
                                      ...
                                      onClick: function () {
                                        return (
                                          ...
                                          (co = ct.parameters),
                                          void Fd(
                                            'qb-interface:targetSelectOption',
                                            {
                                              entity: cB,
                                              option: {
                                                event: cU,
                                      ...
                                      children: Object(FG.jsx)(S0.a, {
                                        onClick: function () {
                                          cM(true),
                                            cv(true),
                                            Fd(
                                              'qb-interface:getBankAccountsByStateID',
                                              { stateid: cR }
                                            ).then(function (cp) {
                                              cd('')
                                              cM(false)
                ...
                'range-picker' === c4.app &&
                  (true === c5.show
                    ? (Sx(true),
                      ...
                      void 0 !== c5.submitUrl
                        ? c3(c5.submitUrl)
                        : c3('qb-interface:rangePickerValues'))
                      ...
                      children: Object(FG.jsx)('div', {
                        children: Object(FG.jsx)(S0.a, {
                          onClick: function () {
                            ...
                            Fd('qb-interface:closeApp', {}).then(function (cw) {
                              true === cw.meta.ok &&
                                Fd(''.concat(c7), {
                                  key: cS,
                                  values: cZ,
                ...
                var cC = Object(Fs.a)(
                  FR.a.mark(function cQ(cx) {
                    var cA = {
                      ...
                      NmIgd: 'qb-interface:fetchContracts',
                      nChUi: 'Kanjo',
                      DfKlA: 'coquettec',
          ...
          SV = function (SU) {
            ...
            var ak = function (aN) {
              Fd('qb-clothing:switchCameraMode', { name: aN })
            }
            Object(F4.useEffect)(function () {
              var aJ = function (aM) {
                'ArrowLeft' === aM.key &&
                  Fd('qb-clothing:rotateCamera', { direction: 'left' })
                'ArrowRight' === aM.key &&
                  Fd('qb-clothing:rotateCamera', { direction: 'right' })
                'a' === aM.key &&
                  Fd('qb-clothing:rotateCamera', { direction: 'left' })
                'd' === aM.key &&
                  Fd('qb-clothing:rotateCamera', { direction: 'right' })
                              ...
                              children: Object(FG.jsxs)(SZ.a, {
                                ...
                                children: [
                                  ...
                                  Object(FG.jsx)(S0.a, {
                                    onClick: function () {
                                      c4(false)
                                      Fd('qb-interface:closeApp', {}).then(
                                        function (aJ) {
                                          true === aJ.meta.ok &&
                                            Fd(
                                              'qb-interface:applicationClosed',
                                              {
                                                name: 'clothing',
                                                fromEscape: true,
                                              }
