...
AddEventHandler("qb-island:enableIsland", function(pEnabled)
  if pEnabled then
    ...
    SetWindSpeed(0.0)
    exports['nns_weather']:FreezeWeather(true, 'Very Sunny')
    SetToggleMinimapHeistIsland(true)
    TriggerEvent('qb-island:onIsland', true)
    TriggerEvent('qb-island:hideBlips', true)
    print('[qb-ISLAND] Cayo Loaded')
    Wait(0)
  ...
  TriggerEvent('qb-island:onIsland', false)
  TriggerEvent('qb-island:hideBlips', false)
  exports['nns_weather']:FreezeWeather(false, 'Very Sunny')
end)

RegisterNetEvent("qb-island:enableSwapping", function(pEnabled)
  isIslandSwappingEnabled = pEnabled
end)
Citizen.CreateThread(function()
  Citizen.Wait(5000)
  TriggerServerEvent("qb-island:checkIslandSwapping")
end)
