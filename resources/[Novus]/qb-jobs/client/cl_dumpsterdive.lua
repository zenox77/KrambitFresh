...
RegisterNetEvent('qb-dumpster')
AddEventHandler('qb-dumpster', function() 
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    if (finished == 100) then 
                        ...
                        local finished = exports ['qb-taskbar']:taskBar(25000, 'Searching Dumpster')
                        if (finished ==100) then
                            TriggerServerEvent('np:giveDumpsterReward')
                            TriggerServerEvent('np:startDumpsterTimer', dumpster)
...
RegisterNetEvent('qb-dumpster2')
AddEventHandler('qb-dumpster2', function() 
    local ped = GetPlayerPed(-1)
    local pos = GetEntityCoords(ped)
    local dumpsterFound = false
        ...
        if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, dumpPos.x, dumpPos.y, dumpPos.z, true) then
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    TaskPlayAnim(GetPlayerPed(-1), dict, 'base', 3.0, -8, -1, 63, 0, 0, 0, 0 )
                    ::skill::
                    local skillfinished = exports["qb-skillbar"]:taskBar(1)
                    if skillfinished then
                        ...
                        if (finished ==100) then
                            TriggerServerEvent('np:giveDumpsterReward')
                            TriggerServerEvent('np:startDumpsterTimer', dumpster2)
                            FreezeEntityPosition(GetPlayerPed(-1),false)
                            ClearPedTasks(GetPlayerPed(-1))
                        end
...
RegisterNetEvent('qb-dumpster3')
AddEventHandler('qb-dumpster3', function() 
    local ped = GetPlayerPed(-1)
    local pos = GetEntityCoords(ped)
    local dumpsterFound = false
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    if skillfinished then
                        ...
                        local finished = exports ['qb-taskbar']:taskBar(15000, 'Searching Dumpster')
                        if (finished ==100) then
                            TriggerServerEvent('np:giveDumpsterReward')
                            TriggerServerEvent('np:startDumpsterTimer', dumpster3)
                            FreezeEntityPosition(GetPlayerPed(-1),false)
                            ClearPedTasks(GetPlayerPed(-1))
                        end
...
RegisterNetEvent('np:removeDumpster')
AddEventHandler('np:removeDumpster', function(object)
    for i = 1, #searched do
