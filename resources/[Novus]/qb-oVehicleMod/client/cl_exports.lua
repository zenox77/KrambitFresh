...
AddEventHandler('baseevents:leftVehicle', function(pVehicle, pSeat, pName, pClass)
    ...
    IsDriving = false
    TriggerEvent("npp-hud:pursuit_mode_off")
...
function HotwireVehicle(cb)
    ...
    --         local finished = exports["qb-taskbarskill"]:taskBar(25000, 3)
    ...
    --         local finished = exports["qb-taskbarskill"]:taskBar(15000, 3)
    --         if finished ~= 100 then
    --             cb({
    --                 success = false,
    --                 stage = 2,
    ...
    --         local finished = exports["qb-taskbarskill"]:taskBar(5000,3)
    --         if finished ~= 100 then
    --             cb({
    --                 success = false,
    --                 stage = 3,
    ...
    --         local finished = exports["qb-taskbarskill"]:taskBar(2000, 8)
    --         if finished ~= 100 then
    --             cb({
    --                 success = false,
    --                 stage = 4,
