...
RegisterNUICallback('wenmoSubmit', function(data)
    ...
    TriggerServerEvent('qb-phone:transferWenmo',num,amount,comment)
end)

RegisterNUICallback("qb-phone:getWenmo", function(data, cb)
    local success, message = RPC.execute("qb-phone:getWenmo")
    local wenmo = {}
