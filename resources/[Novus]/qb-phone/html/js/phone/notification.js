...
btnGasAccept = () => {
	...
	if (gasType == "gas") { 
		$.post("https://qb-phone/purchase_gas", JSON.stringify({}))
	} else if (gasType == "charge") {
		$.post("https://qb-phone/acceptBusinessCharge", JSON.stringify({
			pAmount: chargeAMT,
			pBID: companyID,
			pTargetID: targetID,
			pSenderID: senderIDX
		...
		$.post("https://qb-phone/purchaseCar", JSON.stringify({
			//plate: plate,
			amount: amount,
			senderID: sellerIDc,
		}))
        ...
        $.post("https://qb-phone/accept_tow_job", JSON.stringify({}))
    } else if (gasType == "jobofferdelivery") {
        $.post("https://qb-phone/accept_delivery_job", JSON.stringify({}))
    } else if (gasType == "jobofferdodo") {
        $.post("https://qb-phone/accept_dodo_job", JSON.stringify({}))
    } else if (gasType == "house_robbery") {
        $.post("https://qb-phone/accept_house_robbery", JSON.stringify({}))
    } else if (gasType == "jobofferoxy") {
        $.post("https://qb-phone/accept_oxy_run", JSON.stringify({}))
	} else if (gasType == "jobofferchop") {
        $.post("https://qb-phone/accept_chop_shop", JSON.stringify({}))
	} else if (gasType == "documents") {
		$.post("https://qb-phone/acceptDocumentReceiveRequest", JSON.stringify({
		...
		$.post("https://qb-phone/onPlayerJoinBankBusters", JSON.stringify({
...
btnJobAccept = () => {
	...
	$.post("https://qb-phone/jobOfferAccepted", JSON.stringify({
	}))
}
