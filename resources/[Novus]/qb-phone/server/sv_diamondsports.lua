RPC.register("qb-phone:submitNewEventDiamondSports", function(pSource, pEventName, pEventLocation, pTimeZone, pEventTimeHr, pEventTimeMin, pEventDate)
...
RPC.register("qb-phone:getDiamondSportsEvents", function(pSource)
...
RPC.register("qb-phone:deleteDiamondEvent", function(pSource, pID)
