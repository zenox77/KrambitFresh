...
Citizen.CreateThread(function()
  exports["qb-keybinds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
RegisterNetEvent('qb-propattach:attach')
AddEventHandler('qb-propattach:attach', function(pPropItem, pTargetFunction)
