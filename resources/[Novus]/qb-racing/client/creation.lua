...
function startRaceCreation(options)
    ...
    while raceName ~= nil and options.raceName == nil and RPC.execute("qb-racing:isRaceNameTaken", raceName) == true do
...
function finishRaceCreation()
    ...
    print(raceName, raceType, raceThumbnail, checkpoints)
    TriggerServerEvent("qb-racing:recieveCreateData", raceName, raceType, raceThumbnail, checkpoints)
...
RegisterNetEvent("qb-racing:cmd:racecreate")
AddEventHandler("qb-racing:cmd:racecreate", function(options)
    if GetVehiclePedIsIn(PlayerPedId(), false) ~= 0 then
        startRaceCreation(options)
    end
end)

RegisterNetEvent("qb-racing:cmd:racecreatedone")
AddEventHandler("qb-racing:cmd:racecreatedone", function()
    finishRaceCreation()
end)

RegisterNetEvent("qb-racing:cmd:racecreatecancel")
AddEventHandler("qb-racing:cmd:racecreatecancel", function()
    cancelRaceCreation()
end)
