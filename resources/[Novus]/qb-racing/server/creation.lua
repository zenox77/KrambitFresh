RegisterNetEvent("qb-racing:recieveCreateData")
AddEventHandler("qb-racing:recieveCreateData", function(pRaceName, pRaceType, pRaceThumbnail, pCheckpoints)
    print(pRaceName, pRaceType, pRaceThumbnail, pCheckpoints)
    local pRaceName = tostring(pRaceName) 
    local src = source
    ...
    TriggerClientEvent("qb-racing:addedRace", -1, {}, Races)
    TriggerClientEvent("DoLongHudText", src, "Race " .. pRaceName .. " created!")
end)

RPC.register("qb-racing:isRaceNameTaken", function(src, pRaceName)
