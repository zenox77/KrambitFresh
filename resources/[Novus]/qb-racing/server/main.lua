...
RPC.register("qb-racing:getAllRaces", function(pSrc)
    local src = pSrc
...
RegisterNetEvent('qb-racing:allRaces')
AddEventHandler('qb-racing:allRaces', function()
    local allRaces = {
        races = Races,
        pendingRaces = PendingRaces,
        activeRaces = ActiveRaces,
    ...
    TriggerEvent('qb-phone:allRaces', allRaces) 
end)
...
RPC.register("qb-racing:awardPlayer", function(pSrc, pAmt)
...
Citizen.CreateThread(function()
    ...
    Wait(100)
    TriggerEvent('qb-racing:allRaces')
end)

RPC.register('qb-racing:setAlias', function(src, usedItemIds, usedItemSlots, usedItemMetadatas, aliass)
...
RPC.register('qb-racing:giveRacingUSB', function(pSource)
