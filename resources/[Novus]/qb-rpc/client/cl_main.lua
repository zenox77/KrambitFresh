...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('qb-rpc:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('qb-rpc:cl_response')
AddEventHandler('qb-rpc:cl_response', function(origin, callId, response)
