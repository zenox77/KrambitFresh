...
RegisterNetEvent("qb-sceneui:open-application")
AddEventHandler("qb-sceneui:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("qb-sceneui:application-closed", app, { fromEscape = false })
end
