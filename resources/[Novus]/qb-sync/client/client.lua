...
function syncNative(name, netEntity, options, ...)
    TriggerServerEvent("qb-sync:executeSyncNative", name, netEntity, options, table.pack(...))
end
exports("syncNative", syncNative)

RegisterNetEvent("qb-sync:clientExecuteSyncNative")
AddEventHandler("qb-sync:clientExecuteSyncNative", function(native, netEntity, options, args)
