...
AddEventHandler("qb-ui:voice:setvoiceRange", function(proximity)
    sendAppEvent("hud", {
...
AddEventHandler("qb-ui:voice:setRadioActive", function()
    sendAppEvent("hud", {
        voiceActive = false,
...
AddEventHandler("qb-ui:voice:setRadioActiveFinished", function()
    sendAppEvent("hud", {
        voiceActive = false,
