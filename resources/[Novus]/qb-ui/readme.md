...
exports['qb-ui']:openApplication('textbox', {
    callbackUrl = 'qb-ui:scenes:input', -> callbackUIName
    key = 1,
    items = {
        {
...
RegisterUICallback("qb-ui:scenes:input", function(data, cb)
    ...
    local data = {
        {
            ...
            key = true,
            children = {
				{ title = "Confirm Purchase", action = "qb-ui:wheelchairPurchase", key = true }, -> action is name of UICallback
			},
        },
    }
...
RegisterUICallback("qb-ui:wheelchairPurchase", function(data, cb)
...
####
exports["qb-ui"]:taskBarSkill(timer, skillGapSent)
####
...
###
exports["qb-ui"]:sendAppEvent("game", {
    modeDev = true / false,
