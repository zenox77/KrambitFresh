...
function RequestSirenStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent('qb-vehicleSync:updateSirenState', netId, sirenState, sirenPreset)
    end)
end
...
RegisterNetEvent('qb-vehicleSync:updateSirenState')
AddEventHandler('qb-vehicleSync:updateSirenState', function(pNetId, pSirenState, pSirenPreset)
...
Citizen.CreateThread(function()
    exports["qb-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Turn On/Off Lights", "+toggleSirenLights", "-toggleSirenLights", "Q")
    exports["qb-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Turn On/Off Sound", "+toggleSiren", "-toggleSiren", "LMENU")
    exports["qb-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Cycle Sound", "+cycleSiren", "-cycleSiren", "R")
    exports["qb-keybinds"]:registerKeyMapping("", "Vehicle", "Siren AirHorn", "+sirenAirHorn", "-sirenAirHorn", "E")
end)