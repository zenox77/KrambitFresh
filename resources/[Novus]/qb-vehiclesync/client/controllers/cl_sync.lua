...
function SetEngineSound(pVehicle)
    local sound = exports['qb-vehicles']:GetVehicleAfterMarket(pVehicle, 'engineSound')
...
function RequestSyncStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent('qb-vehicleSync:updateSyncState', netId, syncState)
    end)
end
...
RegisterNetEvent('qb-vehicleSync:updateSyncState')
AddEventHandler('qb-vehicleSync:updateSyncState', function(pNetId, pSyncState)
...
RegisterNetEvent('qb-vehicles:spawnedGarageVehicle')
AddEventHandler('qb-vehicles:spawnedGarageVehicle', function(pNetId, pModel)
    Citizen.Wait(1000)
    ...
    local afterMarkets = exports['qb-vehicles']:GetVehicleAfterMarket(vehicle)
...
Citizen.CreateThread(function()
    exports["qb-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Neon Lights", "+toggleNeonLights", "-toggleNeonLights")
    exports["qb-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Right)", "+toggleRightIndicator", "-toggleRightIndicator")
    exports["qb-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Left)", "+toggleLeftIndicator", "-toggleLeftIndicator")
    exports["qb-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Hazard)", "+toggleHazardLights", "-toggleHazardLights")
end)