...
AddEventHandler("qb-jobmanager:playerBecameJob", function(job, name)
...
--       exports["qb-interface"]:showInteraction("[E] Leave Bed")
...
RegisterNetEvent("qb-hud:changeRange")
AddEventHandler("qb-hud:changeRange", function(pRange)
	if pRange == 1 then 
