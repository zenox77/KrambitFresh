...
Queue.InitHostName = Queue.InitHostName ~= "fmdev" and Queue.InitHostName or false
...
local function playerConnect(name, setKickReason, deferrals)
	...
	-- local BanList = exports['fmdev-admin']:getBanList() 
    local BanList = {}
    Citizen.Wait(500)
	...
	-- 		or (tostring(BanList[i].ip)) == tostring('') 
	...
	-- 					done("You are banned, you may appeal it at https://discord.gg/fmdev | Ban ID: " .. BanList[i].banid .. " | Reason: " .. BanList[i].reason .." | Unban Date: "..  os.date('%Y-%m-%d', BanList[i].expire))					
	-- 					CancelEvent()
	-- 					break
	...
	-- 			exports['fmdev-admin']:deletebanned(license)
	-- 			break
	-- 		elseif tonumber(BanList[i].expire) <= 0 then
	-- 			done("You are banned, you may appeal it at https://discord.gg/fmdev | Ban ID: " .. BanList[i].banid .. " | Reason: " .. BanList[i].reason .." | Unban Date: Permanent") 
	-- 			CancelEvent() 
	-- 			break 
	-- 		end
	-- 	end
    ...
    while true do
        ...
        if Queue.DisplayQueue then
            if Queue.InitHostName then
                ...
                Queue.InitHostName = GetConvar("sv_hostname")
                Queue.InitHostName = Queue.InitHostName ~= "FM | Development" and Queue.InitHostName or false
            end
        end
    end
end)
