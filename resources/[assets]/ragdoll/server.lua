...
RegisterServerEvent('qb-ragdoll:removeallitems')
AddEventHandler('qb-ragdoll:removeallitems', function()
    local src = source
...
AddEventHandler('ragdoll:reviveSV', function(t)
    ...
    TriggerClientEvent('qb-hospital:client:RemoveBleed', t) 
    TriggerClientEvent('qb-hospital:client:ResetLimbs', t)
end)
